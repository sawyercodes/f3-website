    ...
    */
    ...
    function Move(){ 
        ...
        if($firstBG.hasClass("inview")){
            ...
            $firstBG.css({'backgroundPosition': newPos(65, windowHeight, pos, 665, 0.3)}); 
             $firstlogo.css({'backgroundPosition': newPos(5, windowHeight, pos, 1350, 0.8)}); 
        }
        ...
        if($thirdBG.hasClass("inview")){
            //call the newPos function and change the background position
            $thirdBG.css({'backgroundPosition': newPos(75, windowHeight, pos, 2150, 0.3)});
        }
